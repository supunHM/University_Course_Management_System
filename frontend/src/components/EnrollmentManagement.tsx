  ...
  return (
    <Box>
      ...
      >
        ...
        {user?.role === "STUDENT" && (
          <Tab label="Available Courses" icon={<PersonAdd />} />
        )}
        {user?.role === "ADMIN" && (
          <Tab label="All Enrollments" icon={<Assessment />} />
        )}
        {user?.role === "ADMIN" && (
          <Tab label="Manage Enrollments" icon={<Edit />} />
        )}
      </Tabs>
              ...
              >
                <Box sx={{ minWidth: 200 }}>
                  <Autocomplete
                    ...
                    value={
                      students.find(
                        (s) => s.id?.toString() === newEnrollment.studentId
                      ) || null
                    }
                    onChange={(_, value) =>
                      setNewEnrollment({
                ...
                <Box sx={{ minWidth: 200 }}>
                  <Autocomplete
                    ...
                    value={
                      courses.find(
                        (c) => c.id?.toString() === newEnrollment.courseId
                      ) || null
                    }
                    onChange={(_, value) =>
                      setNewEnrollment({
                ...
                <Box>
                  <Button
                    ...
                    disabled={
                      !newEnrollment.studentId || !newEnrollment.courseId
                    }
                  >
                    Enroll
                  </Button>
